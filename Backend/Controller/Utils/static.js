export const staticResponse = {
    emailNotValid:"Email is not valid, Please type valid email address!",
    userExist:"User already exist, Please check!",
    userNameExist:"User Name already exist, Please choose another user name!",
